...
export default function BibliotecaJuegos() {
  ...
  useEffect(() => {
    const fetchJuegos = async () => {
      try {
        ...
        const res = await fetch("https://gametracker-back-production.up.railway.app/api/juegos/obtenerJuegos", {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const token = localStorage.getItem("token");
      const url = isEditing
        ? `https://gametracker-back-production.up.railway.app/api/juegos/editarJuego/${newGame._id}`
        : "https://gametracker-back-production.up.railway.app/api/juegos/crearJuego";
  ...
  const handleDelete = async (id) => {
    ...
    try {
      const token = localStorage.getItem("token");
      const res = await fetch(`https://gametracker-back-production.up.railway.app/api/juegos/eliminarJuego/${id}`, {
        method: "DELETE",
        headers: { Authorization: `Bearer ${token}` },
      });
