...
export default function BibliotecaResenas() {
    ...
    const fetchResenas = async () => {
      try {
        ...
        const res = await fetch(
          `https://gametracker-back-production.up.railway.app/api/resenas/obtenerResenasPorJuego/${juegoId}`,
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const token = localStorage.getItem("token");
      const url = isEditing
        ? `https://gametracker-back-production.up.railway.app/api/resenas/editarResena/${resenaActiva._id}`
        : `https://gametracker-back-production.up.railway.app/api/resenas/crearResena`;
  ...
  const handleEliminar = async (id) => {
    ...
    try {
      const token = localStorage.getItem("token");
      const res = await fetch(
        `https://gametracker-back-production.up.railway.app/api/resenas/eliminarResena/${id}`,
